...
let
    ...
    #"Kategorie erstellen" = Table.AddColumn(Quelle, "Kategorie", each
        ...
        or Text.Contains([#"Auftraggeber/Empfänger"], "HUGENDUBEL")
        or Text.Contains([Verwendungszweck], "GIROCARD")
        or Text.Contains([#"Auftraggeber/Empfänger"], "Bargeldauszahlung") 
        then "Allgemein/Non-Food"

        else if Text.Contains([#"Verwendungszweck"], "Wohngeld")  then "Wohngeld"
        else if Text.Contains([#"Verwendungszweck"], "Privateinlage")  then "Privateinlage"
        else if Text.Contains([#"Verwendungszweck"], "Praxiskredit Sparkasse")  then "Praxiskredit Sparkasse"
        else if Text.Contains([#"Verwendungszweck"], "STEUERNR 156/168/17296")  or Text.Contains([#"Auftraggeber/Empfänger"], "GB Gesunde Steuerberatungsgesellschaft mbH") then "Steuer Praxis"
        else if Text.Contains([#"Verwendungszweck"], "Ausgleich")  then "Ausgleich"
        else if Text.Contains([#"Buchungstext"], "Wertpapierkauf")  then "Sparen"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "Deutsche Arzteversicherung Aktiengesellschaft")  then "Dt. Ärzteversicherung"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "Versorgungswerk der Landeszahnarztekammer Thuringen")  then "Versorgungswerk"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "Barmenia Krankenversicherung AG")  then "Krankenversicherung"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "HUK-COBURG UNTERNEHMENSGRUPPE")  then "Lebensversicherung"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "Zahnarztliche Berufsausubungsgemeinschaft") then "Entnahme/Gehalt"
        else if Text.Contains([#"Auftraggeber/Empfänger"], "Drillisch Online GmbH") then "Handy"
        else if Text.Contains([#"Verwendungszweck"], "Kfz-Steuer") or Text.Contains([#"Auftraggeber/Empfänger"], "OIL") or Text.Contains([#"Verwendungszweck"], "Tankstelle") or Text.Contains([#"Verwendungszweck"], "KRAFTFAHRT-VERSICHERUNG") then "Auto"
