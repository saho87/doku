...
ns sind eine clusterweite Ressource -> können von normalen Usern nicht geändert werden
ns können nach dem Erstellen nicht mehr geändert werden
...
```
<details>
<summary>Beispiel Project Request Template</summary>
